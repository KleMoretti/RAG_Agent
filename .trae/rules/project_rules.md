...
12. **Consistent Styling Approach**
    - ✅ **For `frontend/`**: Use Ant Design components as primary UI library
    - ✅ **For `frontend-shadcn/`**: Use shadcn/ui components with Tailwind CSS
    - ✅ Extend with Tailwind for custom layouts
    - ✅ Define theme tokens in centralized config
...
37. **Language Configuration**
    ...
    - ✅ Use Ant Design's `ConfigProvider` for UI component localization
...
- **Ant Design 5.x** - Enterprise-level UI component library (for `frontend/`)
  - Rich component ecosystem, ideal for B2B applications
  - Comprehensive internationalization support
  - Strong theme customization capabilities
- **shadcn/ui** - Modern headless UI component library (for `frontend-shadcn/`)
...
- **i18n Library**: Ant Design built-in ConfigProvider for UI components + custom i18n solution for content
- **Language Switching**: Stored in `uiStore.language` state, persisted in localStorage
- **Translation Scope**:
  - UI labels, buttons, navigation (Ant Design locale)
