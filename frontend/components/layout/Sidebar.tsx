...
// 管理员菜单项
const adminMenu = [{ key: ROUTES.ADMIN, icon: Settings, label: "系统管理" }];
              ...
              <SidebarMenuButton size="lg" asChild>
                <a href="#" className="group-data-[collapsible=icon]:px-2">
                  <div className="flex flex-col gap-0.5 leading-relaxed group-data-[collapsible=icon]:hidden">
                    <span className="font-logo text-lg tracking-tight leading-tight">
                      CastIron
                    </span>
                    ...
                    return (
                      <SidebarMenuItem key={agent.id}>
                        <SidebarMenuButton
                          ...
                          onMouseEnter={(e) =>
                            handleAgentMouseEnter(agent.id, e)
                          }
